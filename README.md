...
* [Microkit SDK 2.3.0](https://github.com/seL4/microkit/releases/tag/2.3.0)
* GNU Make
...
```sh
wget https://github.com/seL4/microkit/releases/download/2.3.0/microkit-sdk-2.3.0-linux-x86-64.tar.gz
tar xf microkit-sdk-2.3.0-linux-x86-64.tar.gz
```
...
For Apple Silicon:
```sh
wget https://github.com/seL4/microkit/releases/download/2.3.0/microkit-sdk-2.3.0-macos-aarch64.tar.gz
tar xf microkit-sdk-2.3.0-macos-aarch64.tar.gz
```

For Intel:
```sh
wget https://github.com/seL4/microkit/releases/download/2.3.0/microkit-sdk-2.3.0-macos-x86-64.tar.gz
tar xf microkit-sdk-2.3.0-macos-x86-64.tar.gz
```
