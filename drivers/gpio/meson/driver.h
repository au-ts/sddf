...
static const struct meson_irq_function irq_config_control[] = {
   {
      ...
      .registers = (const struct meson_irq_register_data[]){
         { .register_offset = GPIO_INTERUPT_EDGE_AND_POLARITY, .start_bit = 24, .end_bit = 31, .start_channel_number = GPIO_IRQ_0, .is_last = false },
         { .register_offset = AO_IRQ_GPIO_REG, .start_bit = 20, .end_bit = 21, .start_channel_number = GPIO_AO_IRQ_0, .is_last = true }
      }
   },
   {
      .function = MESON_IRQ_REG_EDGE,
      .registers = (const struct meson_irq_register_data[]){
         { .register_offset = GPIO_INTERUPT_EDGE_AND_POLARITY, .start_bit = 0, .end_bit = 7, .start_channel_number = GPIO_IRQ_0, .is_last = false },
         { .register_offset = AO_IRQ_GPIO_REG, .start_bit = 18, .end_bit = 19, .start_channel_number = GPIO_AO_IRQ_0, .is_last = true }
      }
   },
   {
      .function = MESON_IRQ_REG_POL,
      .registers = (const struct meson_irq_register_data[]){
         { .register_offset = GPIO_INTERUPT_EDGE_AND_POLARITY, .start_bit = 16, .end_bit = 23, .start_channel_number = GPIO_IRQ_0, .is_last = false },
         { .register_offset = AO_IRQ_GPIO_REG, .start_bit = 16, .end_bit = 17, .start_channel_number = GPIO_AO_IRQ_0, .is_last = true }
      }
   },
   {
      .function = MESON_IRQ_REG_FIL,
      .registers = (const struct meson_irq_register_data[]){
         { .register_offset = GPIO_FILTER_SELECT, .start_bit = 0, .end_bit = 2, .start_channel_number = GPIO_IRQ_0, .is_last = true },
         { .register_offset = GPIO_FILTER_SELECT, .start_bit = 4, .end_bit = 6, .start_channel_number = GPIO_IRQ_1, .is_last = true },
         { .register_offset = GPIO_FILTER_SELECT, .start_bit = 8, .end_bit = 10, .start_channel_number = GPIO_IRQ_2, .is_last = true },
         { .register_offset = GPIO_FILTER_SELECT, .start_bit = 12, .end_bit = 14, .start_channel_number = GPIO_IRQ_3, .is_last = true },
         { .register_offset = GPIO_FILTER_SELECT, .start_bit = 16, .end_bit = 18, .start_channel_number = GPIO_IRQ_4, .is_last = true },
         { .register_offset = GPIO_FILTER_SELECT, .start_bit = 20, .end_bit = 22, .start_channel_number = GPIO_IRQ_5, .is_last = true },
         { .register_offset = GPIO_FILTER_SELECT, .start_bit = 24, .end_bit = 26, .start_channel_number = GPIO_IRQ_6, .is_last = true },
         { .register_offset = GPIO_FILTER_SELECT, .start_bit = 28, .end_bit = 30, .start_channel_number = GPIO_IRQ_7, .is_last = true },
         { .register_offset = AO_IRQ_GPIO_REG, .start_bit = 8, .end_bit = 10, .start_channel_number = GPIO_AO_IRQ_0, .is_last = true },
         { .register_offset = AO_IRQ_GPIO_REG, .start_bit = 12, .end_bit = 14, .start_channel_number = GPIO_AO_IRQ_1, .is_last = true },
      }
   },
   {
      .function = MESON_IRQ_REG_AOSEL,
      .registers = (const struct meson_irq_register_data[]){
         { .register_offset = AO_IRQ_GPIO_REG, .start_bit = 0, .end_bit = 7, .start_channel_number = GPIO_AO_IRQ_0, .is_last = true }
      }
   },
   {
      .function = MESON_IRQ_REG_SEL,
      .registers = (const struct meson_irq_register_data[]){
         { .register_offset = GPIO_0_3_PIN_SELECT, .start_bit = 0, .end_bit = 31, .start_channel_number = GPIO_IRQ_0, .is_last = false },
         { .register_offset = GPIO_4_7_PIN_SELECT, .start_bit = 0, .end_bit = 31, .start_channel_number = GPIO_IRQ_4, .is_last = true }
      }
   }
};
