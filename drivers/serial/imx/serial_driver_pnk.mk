...
clean::
	rm -f serial/imx/serial_driver_init_pnk.[do] serial/imx/serial_driver.o
	rm -f serial/imx/serial_driver_pre.[do] serial/imx/serial_driver_pnk.pnk
	rm -f serial/imx/serial_driver_pnk.[doS]
