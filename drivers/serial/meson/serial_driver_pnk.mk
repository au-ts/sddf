...
clean::
	rm -f serial/meson/serial_driver_init_pnk.[do] serial/meson/serial_driver.o
	rm -f serial/meson/serial_driver_pre.[do] serial/meson/serial_driver_pnk.pnk
	rm -f serial/meson/serial_driver_pnk.[doS]
