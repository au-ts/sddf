...
The pinmux driver must be exclusively run at the highest priority to ensure that it is the first PD initialised in the system. At `init()` time, the driver to read the encoded pinmux data and write it into the pinmux device.
