...
extern const uint64_t pcie_ecam_size;

extern const uint64_t ahci_abar_paddr;
extern const uint64_t ahci_abar_vaddr;
extern const uint64_t ahci_abar_size;

#define SATA_BASE_CLASS_CODE 0x01
#define SATA_SUBCLASS_CODE 0x06
#define AHCI_PROG_IF 0x01 // usually prog_if == 0x01 for AHCI 1.0.
