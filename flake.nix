...
#
{
  ...
  outputs =
    ...
    let
      microkit-version = "2.0.1-dev.120+2bdc2b5";
      microkit-platforms = {
        ...
        in
        {
          ...
          default = pkgs.mkShellNoCC rec {
            ...
            env.MICROKIT_SDK = pkgs.fetchzip {
              ...
              hash =
                {
                  aarch64-darwin = "sha256-1yb73jjTWLOzQxrxOQeblqbyLsz92ngevU2swRWIunw=";
                  x86_64-darwin = "sha256-/88YwYCM2duwwC85oWfAwYAomkpJiN0xBMGGiC7xhoc=";
                  x86_64-linux = "sha256-EIqZtP2CaFNWSPPv9EnLwepGp76pvtkGaM+E1nCys9w=";
                  aarch64-linux = "sha256-Uv+l5YLqCey5z2VxYf9mmi5QiUGWh0HaGWS74QUTatM=";
                }
