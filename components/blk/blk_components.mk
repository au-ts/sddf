...
blk_virt.o: ${SDDF}/components/blk/virt.c | $(SDDF_LIBC_INCLUDE)
	${CC} ${CFLAGS} -I${SDDF}/components/blk ${CFLAGS_blk} -o $@ -c $<

blk_partitioning.o: ${CHECK_BLK_FLAGS_MD5}
blk_partitioning.o: ${SDDF}/components/blk/partitioning.c | $(SDDF_LIBC_INCLUDE)
