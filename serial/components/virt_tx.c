...
void init(void)
{
    ...
    if (config.enable_rx) {
         ...
         * driver we can encounter scenarious where the printing is inter-leaved with each other.
         * Because of this, for now, in debug we busy loop until we know the driver has finished
