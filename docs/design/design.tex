...
\newcommand{\Release}{Release 0.7, 2026-08-19}
% Release 0.7: changeset 79816a01 aka RELEASE_0_7

% \newcommand{\Release}{Draft Release 0.8}


\documentclass[a4paper,12pt]{report}
\usepackage[copyright]{unsw}
\copyYear{2022, 2024, 2026}
...
\author{Gernot Heiser, Peter Chubb, Alex Brown, Tristan Clinton-Muehr,
        Courtney Darville, Alwin Joshy, Craig McLaughlin, Bill Nguyen, Lesley Rossouw,
        Lucy Fletcher, Julia Vassiliki, Ivan Velickovic, Jade Zhou}
...
\section{Changes For Release 0.7 of 2025-03-21}

Updates to the I2C class following a redesign \autoref{s:cl-i2c}.
