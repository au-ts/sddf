...
static inline void __libc_memcpy_bytewise(unsigned char *dst, const unsigned char *src, const size_t sz)
{
...
static uintxlen_t __libc_load_xlen(const void *src)
{
    ...
    unsigned char b6 = *p++;
    unsigned char b7 = *p++;
    ret |= ((uintxlen_t)b4 << 32) | ((uintxlen_t)b5 << 40) | ((uintxlen_t)b6 << 48) | ((uintxlen_t)b7 << 56);
#endif
    return ret;
}
#endif

void *__inhibit_loop_to_libcall sddf_memcpy(void *__restrict aa, const void *__restrict bb, size_t n)
{
