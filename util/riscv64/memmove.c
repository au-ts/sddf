...
static inline uint8_t __libc_fast_xlen_aligned(void *dst, const void *src)
{
...
#if !defined(__riscv_misaligned_fast)
static inline void __libc_memmove_misaligned_copy(unsigned char *dst, const uintxlen_t *aligned_src)
{
...
static inline void __libc_aligned_copy_unrolled(uintxlen_t *aligned_dst, const uintxlen_t *aligned_src)
{
...
static inline void __libc_memmove_bytewise_forward_copy(unsigned char *dst, const unsigned char *src, size_t length)
{
    while (length--) {
        *dst++ = *src++;
    }
...
void *__inhibit_loop_to_libcall sddf_memmove(void *dst_void, const void *src_void, size_t length)
{
