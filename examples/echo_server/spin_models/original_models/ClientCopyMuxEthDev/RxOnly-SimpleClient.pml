...
// OUTCOME: With priorities, verifies in 0.01 seconds. Without priorities, deadlocks when MUX_RX interrupts
// ETH before setting ETH_RX_free.notify_flag to 1, causing CPY_RX_free.notify_flag to be set to 0. Then
// CPY does not notify MUX_RX when free buffers are added to CPY_RX_free
                ...
                :: CLT_RX_used.notification ? 1 ->
                    d_step {
                        do
                            ...
                            :: !EMPTY(CLT_RX_used) ->
                                // Transfer packet to RX free ring
    ...
    do
        ...
        :: CPY_RX_free.notification ? 1 ->
            ...
            if
                ...
                :: ETH_RX_free.notify_flag -> CPY_RX_free.notify_flag = 1;
                :: else -> CPY_RX_free.notify_flag = 0;
            fi
