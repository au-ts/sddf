// COMPONENTS: CLIENT, MUX_RX, MUX_TX, ETH, ETH2, DEV (SPLIT DRIVER)
// SIMPLIFICATIONS: Client passes packets straight from rx used to rx free and tx free to tx used 
// OUTCOME: With priorities, verifies in 0 seconds. Without priorities, can't verify in a reasonable amount of time
