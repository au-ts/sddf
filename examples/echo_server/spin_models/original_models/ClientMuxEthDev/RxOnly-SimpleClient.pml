...
// ETH before setting ETH_RX_free.notify_flag to 1, causing CLT_RX_free.notify_flag to be set to 0. Then
// CLT does not notify MUX_RX when free buffers are added to CLT_RX_free
