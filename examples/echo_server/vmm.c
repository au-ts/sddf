...
void init(void) {
    ...
    size_t net_rx_size, net_tx_size;
    net_cli_queue_capacity(microkit_name, &net_rx_size, &net_tx_size);
    net_queue_init(&net_rx_queue, net_rx_free, net_rx_active, net_rx_size);
    net_queue_init(&net_tx_queue, net_tx_free, net_tx_active, net_tx_size);
