...
pub fn build(b: *std.Build) !void {
    ...
    microkit_tool_cmd.addArgs(&[_][]const u8{ b.getInstallPath(.{ .custom = "meta_output" }, "i2c.system"), "--search-path", b.getInstallPath(.bin, ""), "--board", microkit_board, "--config", microkit_config, "-o", final_image_dest, "-r", b.getInstallPath(.prefix, "./report.txt") });
