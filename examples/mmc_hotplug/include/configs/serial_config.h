...
#define SERIAL_CLI0_NAME    "plug_controller"
...
#define SERIAL_TX_DATA_REGION_CAPACITY_DRIV            (SERIAL_NUM_CLIENTS * SERIAL_DATA_REGION_CAPACITY)
...
#define SERIAL_MAX_TX_DATA_CAPACITY MAX(SERIAL_TX_DATA_REGION_CAPACITY_DRIV, SERIAL_TX_DATA_REGION_CAPACITY_CLI0)
