...
#define SERIAL_MAX_TX_DATA_SIZE MAX(SERIAL_TX_DATA_REGION_SIZE_DRIV, SERIAL_TX_DATA_REGION_SIZE_CLI0)
#define SERIAL_MAX_RX_DATA_SIZE MAX(SERIAL_RX_DATA_REGION_SIZE_DRIV, SERIAL_RX_DATA_REGION_SIZE_CLI0)
