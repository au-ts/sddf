...
pub fn build(b: *std.Build) !void {
    ...
    const driver_objcopy = updateSectionObjcopy(b, ".device_resources", meta_output, "blk_driver_device_resources.data", "blk_driver.elf");
    driver_objcopy.step.dependOn(&driver_install.step);
    const objcopys = &.{ client_objcopy, virt_objcopy, driver_objcopy };
