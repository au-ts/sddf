...
This example utilises the `enable_color` feature of the serial subsystem described in the [Microkit
sdfgen documentation](https://github.com/au-ts/microkit_sdf_gen/).
...
The serial client demonstrates two methods of outputting to serial: the first uses `sddf_printf`
...
In this example, `enable_color` is set to `True` (which is by default when creating a serial
