...
pub fn build(b: *std.Build) !void {
    ...
    const sound_driver_install = b.addInstallArtifact(sddf_dep.artifact("driver_sound_virtio.elf"), .{ .dest_sub_path = "sound_driver.elf"});
    ...
    // }
    microkit_tool_cmd.step.dependOn(&sound_driver_install.step);
    ...
    if (microkit_board_option == .qemu_virt_aarch64) {
        ...
        qemu_cmd = b.addSystemCommand(&[_][]const u8{
            "/home/ivanv/ts/qemu/build/qemu-system-aarch64",
            "-machine",
