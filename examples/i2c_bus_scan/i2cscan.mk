...
$(SYSTEM_FILE): $(METAPROGRAM) $(IMAGES) $(DTB)
	...
	$(OBJCOPY) --update-section .i2c_client_config=client_scan_i2c_client_config.data client_scan.elf
	$(OBJCOPY) --update-section .timer_client_config=client_scan_timer_client_config.data client_scan.elf
	...
	$(OBJCOPY) --update-section .serial_client_config=client_scan_serial_client_config.data client_scan.elf
