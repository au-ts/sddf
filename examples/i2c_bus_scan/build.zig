...
const MicrokitBoard = enum { odroidc4, serengeti };
...
pub fn build(b: *std.Build) !void {
    ...
    const client_scan = b.addExecutable(.{
        .name = "client_scan.elf",
    ...
    const client_scan_serial_objcopy = updateSectionObjcopy(b, ".serial_client_config", meta_output, "serial_client_client_scan.data", "client_scan.elf");
    ...
    const client_scan_timer_objcopy = updateSectionObjcopy(b, ".timer_client_config", meta_output, "timer_client_client_scan.data", "client_scan.elf");
    ...
    const client_scan_i2c_objcopy = updateSectionObjcopy(b, ".i2c_client_config", meta_output, "i2c_client_client_scan.data", "client_scan.elf");

    const objcopys = &.{
        serial_driver_resources_objcopy,
        serial_driver_config_objcopy,
        serial_virt_objcopy,
        client_scan_serial_objcopy,
        client_scan_i2c_objcopy,
        client_scan_timer_objcopy,
        i2c_virt_objcopy,
