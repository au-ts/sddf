...
$(SYSTEM_FILE): $(METAPROGRAM) $(IMAGES) $(DTB)
	...
	$(OBJCOPY) --update-section .i2c_client_config=i2c_client_client_ina.data client_ina.elf
	$(OBJCOPY) --update-section .timer_client_config=timer_client_client_ina.data client_ina.elf
	$(OBJCOPY) --update-section .device_resources=serial_driver_device_resources.data serial_driver.elf
	$(OBJCOPY) --update-section .serial_driver_config=serial_driver_config.data serial_driver.elf
	$(OBJCOPY) --update-section .serial_virt_tx_config=serial_virt_tx.data serial_virt_tx.elf
	$(OBJCOPY) --update-section .serial_client_config=serial_client_client_ina.data client_ina.elf
	touch $@
